...
const STEPS = [
  {
    ...
    desc: "Koneksikan akun Shopee, Tokopedia, dan TikTok Shop via halaman Pengaturan Toko.",
  },
  {
    n: "2",
    title: "Mapping SKU",
    desc: "Petakan tiap varian master ke SKU marketplace masing-masing satu kali.",
  },
  {
    n: "3",
    title: "Jualan tanpa oversell",
    desc: "Setiap order masuk via webhook langsung mengurangi stok central dan menyebar ke semua channel.",
  },
];
      ...
      <header className="sticky top-0 z-20 bg-white/80 backdrop-blur border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="text-sm font-medium px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100"
            >
              Masuk
            </Link>
            <Link
              href="/dashboard"
              className="text-sm font-semibold px-4 py-2 rounded-lg bg-gray-900 text-white hover:bg-black flex items-center gap-1"
            >
      ...
      <main>
        <section className="max-w-6xl mx-auto px-6 pt-16 pb-12 text-center">
          ...
          <div className="mt-8 flex items-center justify-center gap-3">
            <Link
              href="/dashboard"
              className="px-6 py-3 rounded-xl bg-gray-900 text-white text-sm font-semibold hover:bg-black flex items-center gap-2"
            >
              Buka Dashboard <ArrowRight size={16} />
            </Link>
            <a
        ...
        <section className="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-2 gap-6">
          <div className="border border-red-100 bg-red-50/50 rounded-2xl p-6">
            <h2 className="font-bold text-lg mb-2">Tanpa sinkron yang benar…</h2>
          ...
          <div className="border border-emerald-100 bg-emerald-50/50 rounded-2xl p-6">
            <h2 className="font-bold text-lg mb-2">Dengan Maxius…</h2>
            <ul className="text-sm text-gray-700 space-y-2 list-disc pl-5">
        ...
        <section id="fitur" className="max-w-6xl mx-auto px-6 pb-14">
          <h2 className="text-2xl font-bold">Fitur inti</h2>
          <p className="text-sm text-gray-500 mt-1">Dibangun untuk correctness stok, bukan sekadar pajangan.</p>
          <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((f) => (
              <div key={f.title} className="border border-gray-200 rounded-2xl p-5 hover:border-gray-900 transition-colors">
        ...
        <section id="cara-kerja" className="bg-gray-900 text-white">
          <div className="max-w-6xl mx-auto px-6 py-14">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/login"
                className="px-6 py-3 rounded-xl bg-white text-gray-900 text-sm font-semibold hover:bg-gray-100 flex items-center gap-2"
              >
                Masuk untuk mulai <ArrowRight size={16} />
              </Link>
              <Link
                href="/dashboard"
                className="px-6 py-3 rounded-xl border border-white/20 text-sm font-semibold hover:bg-white/10"
              >
                Buka Dashboard
              </Link>
            </div>
