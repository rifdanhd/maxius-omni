...
export class CustomerServiceV202309Api {
     ...
     * @param needSessionInfo Set to true when session info is required.
     * @param shopCipher 
     */
    public async ConversationsGet (pageSize: number, xTtsAccessToken: string, contentType: string, pageToken?: string, locale?: string, needSessionId?: boolean, needSessionInfo?: boolean, shopCipher?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomerService202309GetConversationsResponse;  }> {
        ...
        if (needSessionInfo !== undefined) {
            localVarQueryParameters['need_session_info'] = ObjectSerializer.serialize(needSessionInfo, "boolean");
        }
