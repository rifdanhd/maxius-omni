...
import { Promotion202406SearchCouponListRequestBody } from '../model/promotion/V202406/SearchCouponListRequestBody';
import { Promotion202406SearchCouponListResponse } from '../model/promotion/V202406/SearchCouponListResponse';
...
export class PromotionV202406Api {
     ...
     * @param shopCipher 
     * @param SearchCouponListRequestBody 
     */
    public async CouponsSearchPost (xTtsAccessToken: string, contentType: string, pageToken?: string, pageSize?: number, shopCipher?: string, SearchCouponListRequestBody?: Promotion202406SearchCouponListRequestBody, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Promotion202406SearchCouponListResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(SearchCouponListRequestBody, "Promotion202406SearchCouponListRequestBody")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Promotion202406SearchCouponListResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Promotion202406SearchCouponListResponse");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
