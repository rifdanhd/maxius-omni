...
export class FulfillmentV202309Api {
    ...
    /**
     * Use this API to update the delivery status of a package from \'TTS\' to \'DELIVERED\'. Only sellers using SOF (Seller Own Fleet) or O2O (Store Pickup) are allowed to update the package status to \'DELIVERED\' through this API. This API is available only in the SEA region.
