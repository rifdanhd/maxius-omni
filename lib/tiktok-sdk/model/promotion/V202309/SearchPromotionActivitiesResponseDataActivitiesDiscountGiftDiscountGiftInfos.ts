...
import { Promotion202309SearchPromotionActivitiesResponseDataActivitiesDiscountGiftDiscountGiftInfosGiftDetails } from './SearchPromotionActivitiesResponseDataActivitiesDiscountGiftDiscountGiftInfosGiftDetails';

export class Promotion202309SearchPromotionActivitiesResponseDataActivitiesDiscountGiftDiscountGiftInfos {
    /**
    * Gift configurations related to Gift With Purchase (GWP) promotions. 
    */
    'giftDetails'?: Array<Promotion202309SearchPromotionActivitiesResponseDataActivitiesDiscountGiftDiscountGiftInfosGiftDetails>;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<Promotion202309SearchPromotionActivitiesResponseDataActivitiesDiscountGiftDiscountGiftInfosGiftDetails>"
        },
        {
            "name": "thresholdType",
    ...
    static getAttributeTypeMap() {
        return Promotion202309SearchPromotionActivitiesResponseDataActivitiesDiscountGiftDiscountGiftInfos.attributeTypeMap;
    }
}
