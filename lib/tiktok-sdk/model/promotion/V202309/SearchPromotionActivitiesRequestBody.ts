...
export class Promotion202309SearchPromotionActivitiesRequestBody {
    /**
    * Activity title key words. No fuzzy matching.
    */
    'activityTitle'?: string;
    /**
    * The type of activities. If `activity_type` isn\'t passed, return activities of all types. Possible values: - `FIXED_PRICE`: product discount activity with fixed price. - `DIRECT_DISCOUNT`: product discount activities with percentage off. - `FLASHSALE`: flash sale activity. - `SHIPPING_DISCOUNT`: shipping fee discount. - `BUY_MORE_SAVE_MORE`: Buy more save more discount.
    */
    'activityType'?: string;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return Promotion202309SearchPromotionActivitiesRequestBody.attributeTypeMap;
    }
}
