...
export class Fulfillment202309UpdatePackageDeliveryStatusRequestBodyPackages {
    /**
    * Delivery status of the package. Possible values for in-store pick up: - `DELIVERY_SUCCESS`: The package has been successfully delivered.  Possible values for SOF (Seller Own Fleet):  - `DELIVERY_SUCCESS`: The package has been successfully delivered.   - `DELIVERY_FAILED`: The package could not be delivered successfully.   - `UPDATE_POD`: Updates the attachment for a package that has already been delivered.
    */
    'deliveryType'?: string;
    /**
    ...
    */
    'id'?: string;
    /**
    * The verification code required for order pickup.
    */
