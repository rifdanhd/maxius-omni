...
import { Product202309RecommendCategoryRequestBodyOriginPlatformCategory } from './RecommendCategoryRequestBodyOriginPlatformCategory';
import { Product202309RecommendCategoryRequestBodyOriginPlatformProductMetaData } from './RecommendCategoryRequestBodyOriginPlatformProductMetaData';

export class Product202309RecommendCategoryRequestBody {
    /**
    * Filter categories by the category tree version.Possible values based on region: - US, EU and SEA: v2, represents the 7-level category tree.  Important: For US, EU and SEA shops, you must pass v2 when using this API. - Other regions: v1, represents the 3-level category tree.Default: v1
    */
    ...
    */
    ...
    /**
    * The BCP-47 locale codes for displaying category information. Default: The default locale of your shop. Possible values: - `cs-CZ` - `de-AT` - `de-BE` - `de-DE` - `el-GR` - `en-GB` - `en-IE` - `en-US` - `es-ES` - `es-MX` - `fr-FR` - `fr-BE` - `hu-HU` - `id-ID` - `it-IT` - `ja-JP` - `ms-MY` - `nl-NL` - `nl-BE` - `pl-PL` - `pt-BR` - `pt-PT` - `th-TH` - `vi-VN` - `zh-CN`
    */
    'locale'?: string;
    'originPlatformCategory'?: Product202309RecommendCategoryRequestBodyOriginPlatformCategory;
    'originPlatformProductMetaData'?: Product202309RecommendCategoryRequestBodyOriginPlatformProductMetaData;
    /**
    * The product type defined on the source platform.
    */
    'originPlatformProductType'?: string;
    /**
    * Tags associated with the product on the source platform.
    */
    'originPlatformTags'?: Array<string>;
    /**
    * The product vendor or brand name on the source platform.
    */
    'originPlatformVendor'?: string;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "originPlatformCategory",
            "baseName": "origin_platform_category",
            "type": "Product202309RecommendCategoryRequestBodyOriginPlatformCategory"
        },
        {
            "name": "originPlatformProductMetaData",
            "baseName": "origin_platform_product_meta_data",
            "type": "Product202309RecommendCategoryRequestBodyOriginPlatformProductMetaData"
        },
        {
            "name": "originPlatformProductType",
            "baseName": "origin_platform_product_type",
            "type": "string"
        },
        {
            "name": "originPlatformTags",
            "baseName": "origin_platform_tags",
            "type": "Array<string>"
        },
        {
            "name": "originPlatformVendor",
            "baseName": "origin_platform_vendor",
            "type": "string"
        },
        {
            "name": "productTitle",
